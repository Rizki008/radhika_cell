    ...
    <div class="pd-ltr-20 xs-pd-20-10">
        <div class="min-height-200px">
            ...
            <div class="pd-20 card-box mb-30">
                ...
                echo form_open_multipart('masterproduk/add') ?>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Nama Produk</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" type="text" placeholder="Nama Produk" name="nama_produk" value="<?= set_value('nama_produk') ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" placeholder="Harga Produk" type="number" name="harga" value="<?= set_value('harga') ?>" required>
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Berat Produk</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" name="berat" value="<?= set_value('berat') ?>" required placeholder="Berat Produk" type="number">
                    </div>
                </div>
                <div class="form-group row">
                    <label class="col-sm-12 col-md-2 col-form-label">Quantity Produk</label>
                    <div class="col-sm-12 col-md-10">
                        <input class="form-control" name="stock" value="<?= set_value('stock') ?>" required placeholder="Quantity Produk" type="number">
                    </div>
                </div>
                <div class="form-group row">
