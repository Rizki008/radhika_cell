                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            <div class="col-sm-6">
                                <h1><span>Radhika</span>-Cellular</h1>
                                <h2>Free E-Commerce Template</h2>
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. </p>
                                <button type="button" class="btn btn-default get">Get it now</button>
                            </div>
                            <div class="col-sm-6">
                                <img src="<?= base_url() ?>eshopper/images/home/girl1.jpg" class="girl img-responsive" alt="" />
                                <img src="<?= base_url() ?>eshopper/images/home/pricing.png" class="pricing" alt="" />
                            </div>
                        </div>
                        <div class="item">
                            <div class="col-sm-6">
                            ...
                            <div class="col-sm-6">
                                <img src="<?= base_url() ?>eshopper/images/home/girl2.jpg" class="girl img-responsive" alt="" />
                                <img src="<?= base_url() ?>eshopper/images/home/pricing.png" class="pricing" alt="" />
                            </div>
                        </div>
                        ...
                        <div class="item">
                            ...
                            <div class="col-sm-6">
                                <img src="<?= base_url() ?>eshopper/images/home/girl3.jpg" class="girl img-responsive" alt="" />
                                <img src="<?= base_url() ?>eshopper/images/home/pricing.png" class="pricing" alt="" />
                            </div>
                        </div>
                                    ...
                                    <div class="product-image-wrapper">
                                        <div class="single-products">
                                            <div class="productinfo text-center">
                                                ...
                                                <h2>Rp. <?= number_format($value->harga - $value->harga_promo, 0) ?></h2>
                                                <p><?= $value->nama_produk ?></p>
                                                <button class="btn btn-default add-to-cart" type="submit" data-name="<?= $value->nama_produk ?>" data-price="<?= ($value->harga_promo > 0) ? ($value->harga - $value->harga_promo) : $value->harga ?>" data-id="<?= $value->id_produk ?>"><i class="fa fa-shopping-cart"></i>Add to cart</button>
                                            </div>
                                        </div>
                                    </div>
                                    <?php echo form_close() ?>
