        ...
        <div class="card-box mb-30">
            ...
            <table class="data-table table nowrap">
                ...
                <tbody>
                    <tr>
                        <td class="table-plus">
                            <img src="<?= base_url() ?>deskapp-master/vendors/images/product-1.jpg" width="70" height="70" alt="">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="table-plus">
                            <img src="<?= base_url() ?>deskapp-master/vendors/images/product-2.jpg" width="70" height="70" alt="">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="table-plus">
                            <img src="<?= base_url() ?>deskapp-master/vendors/images/product-3.jpg" width="70" height="70" alt="">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="table-plus">
                            <img src="<?= base_url() ?>deskapp-master/vendors/images/product-4.jpg" width="70" height="70" alt="">
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="table-plus">
                            <img src="<?= base_url() ?>deskapp-master/vendors/images/product-5.jpg" width="70" height="70" alt="">
                        </td>
                        <td>
            ...
            <div class="bg-white pd-20 card-box mb-30">
                <h4 class="h4 text-blue">Analisis Pelanggan Loyal</h4>
                <!-- <div id="chart1"></div> -->
                <?php
                ...
                ?>
                <canvas id="Line" height="100" style="height: 100px;"></canvas>
                <script>
            ...
            <div class="bg-white pd-20 card-box mb-30">
                ...
                ?>
                <canvas id="bar" height="100" style="height: 100px;"></canvas>
                <script>
